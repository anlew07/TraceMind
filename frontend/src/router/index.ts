...
import { hasSeenLanding } from '@/services/landingPreference'
...
export function createTraceMindRouter(
    ...
    routes: [
      {
        path: '/',
        name: 'root-entry',
        redirect: () => (hasSeenLanding() ? '/knowledge-bases' : '/landing'),
      },
...
export default createTraceMindRouter()
